...
#### There are a total of 4 datasets that come with this publication correspondinging to 2 charts (with 2 figures in each chart - (a) Appeals level and (b) District level). However, the datasets aren't labeld whether they are Appeals or District level, so I went in order of how the datasets were labeled - "figure_1.csv" corresponds to "Figure 1 (a) Appeals level" (from the paper), "figure_2.csv" correponds "Figure 1 (b) District level", "figure_3.csv" correponds "Figure 2 (a) Appeals level", "figure_4.csv" correponds "Figure 2 (b) District level",

# All plots have a width 0f 7, instead of the default 4. We expand the width because many of these figures include side by side charts, and in order to have 8pt font (10 in R) that does not overlap, we need wider charts.
