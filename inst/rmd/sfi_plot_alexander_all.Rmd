...
# ------------------------------------------------------------------------------
# Read in Alexander et al 
alexander_et_al_1 <- read_csv('~/Documents/sfi/data-raw/Databrew Graphics/Alexander et al/Figure 1.csv')
alexander_et_al_1 <- alexander_et_al_1[!is.na(alexander_et_al_1$case_number),]

# read in figure 6
alexander_et_al_6 <- read_excel('~/Documents/sfi/data-raw/Databrew Graphics/Alexander et al/Figure 6.xlsx', sheet = 1)

# read in figures 4 and 7 and seperate, also rename columns and remove NA
alexander_et_al_4_7 <- read_excel('~/Documents/sfi/data-raw/Databrew Graphics/Alexander et al/Figures 4 _7.xlsx', sheet = 1)
