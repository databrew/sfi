...
% Font
\usepackage{fontspec}
\setmainfont{Bright/cmunbbx.ttf}
\setsansfont[BoldFont={Bright/cmunbmo.ttf}]{Bright/cmunbbx.ttf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{barplot}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{/home/benbrew/Documents/sfi/all_plots_files/figure-latex/unnamed-chunk-1-1.pdf}
